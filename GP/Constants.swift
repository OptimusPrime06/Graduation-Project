...
struct Constants {
    ...
    //MARK: - Colors
    static let signUpTextFieldsBackgroundColor = "signUpTextFieldBackgroundColor"
    static let logIntextFieldBackgroundColor = "logIntextFieldBackgroundColor"
    
    static let previousPageColor = "previousPageColor"
    static let currentPageColor = "currentPageColor"
    static let nextPageColor = "nextPageColor"
    
    static let nextButtonColor = "nextButtonColor"
